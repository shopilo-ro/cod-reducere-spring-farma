#!/usr/bin/env node
/**
 * Fetch coduri reducere Spring Farma de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/springfarma.com
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/springfarma.com";
const STORE_NAME  = "Spring Farma";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-spring-farma)" }
  });
