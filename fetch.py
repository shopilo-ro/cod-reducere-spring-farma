#!/usr/bin/env python3
"""
Fetch coduri de reducere Spring Farma de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/springfarma.com
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/springfarma.com"
STORE_NAME = "Spring Farma"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Spring Farma de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-spring-farma)"
    }
    try:
